...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative bg-white text-black border-r border-gray-300">
      {/* ------- header ------- */}
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-gray-300">
        ...
        />
        <p className="flex-1 text-lg flex items-center gap-2 font-medium">
          ...
          >
            {msg.image ? (
              <img
                src={msg.image}
                alt=""
                className="max-w-[230px] border border-gray-300 rounded-lg mb-8"
              />
            ) : (
              <p
                className={`p-2 max-w-[200px] md:text-sm font-normal rounded-lg mb-8 break-words text-sm ${
